...
public class Driver
{
    ...
    {
        SuperList<String> mylist = new SuperList<String>();		System.out.println("The size is = " + mylist.size());
        ...
        String removeItem100  = mylist.remove    (100);			System.out.println("Getting index 100 [Contains =>>>] :"+ mylist.get(100));
        String removeItemLast = mylist.removeLast	();

        for (String s : mylist)
            System.out.println(s);

        mylist.clear();											System.out.println("There is nothing now");
